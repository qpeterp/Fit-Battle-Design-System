...
//    ): FitBattleShape = FitBattleShape(
//        small, medium, large
//    )

    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other !is FitBattleShape) return false
...
internal val LocalShape = staticCompositionLocalOf { FitBattleShape() }